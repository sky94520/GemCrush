...
{
	//窗口创建成功
	if(Director::getInstance()->init("RPG",SDL_WINDOWPOS_CENTERED,SDL_WINDOWPOS_CENTERED,640,900,SDL_WINDOW_SHOWN))
	{
		...
		//第一个启动场景
		Director::getInstance()->runWithScene(GemstoneLayer::createScene());
